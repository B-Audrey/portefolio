    ...
    return (
        <div className='bio'>
            ...
            <div className='bio__text'>
                <p >Ayant toujours eu un attrait pour l'informatique, j'ai décidé en Septembre 2022 de me reconvertir pour devenir développeuse Web. Après quelques mois en autonomie, j'ai intégré un parcours certifiant avec Openclassrooms. Je valide donc un diplôme de conceptrice/intégratrice web en 2023.</p>
