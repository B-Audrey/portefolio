...
const Bio = () => {
    return (
        <div className='bio'>
            <p className='bio__text'>Ayant toujours eu un attrait pour l'informatique, j'ai décidé en septmbre 2022 de me reconvertir pour devenir développeuse Web. Après quelques mois en autonomie, j'ai intégré un parcours certifiant avec Openclassrooms. Je valide donc un diplôme de concepteur / intéragteur web en 2023.</p>
